...
УВАГА — поширені русизми, яких НЕ можна вживати:
- "неділя" в значенні "7 днів" → правильно: "тиждень" (неділя = тільки sunday, один день!)
- "слідуючий" → правильно: "наступний"
- "приймати участь" → правильно: "брати участь"
- "по факту" → правильно: "насправді", "фактично"
- "вірогідно/вірогідність" в значенні "ймовірність" → правильно: "ймовірність"
- "співпадати" → правильно: "збігатися"
- "співпадіння" → правильно: "збіг"
- "відсутність" → правильно: "немає" (де доречно)
- "учбовий" → правильно: "навчальний"
- "включати в себе" → правильно: "містити", "охоплювати"
- "положення" в значенні "ситуація" → правильно: "становище", "ситуація"
- "являється" → правильно: "є"
- "у даний момент" → правильно: "зараз", "цієї миті"
"""
...
Правила:
- Українською, тепло і природно, без канцеляризмів і русизмів
...
УВАГА — поширені русизми, яких НЕ можна вживати:
- "неділя" в значенні "7 днів" → "тиждень" (неділя = тільки sunday!)
- "слідуючий" → "наступний"
- "вірогідність" → "ймовірність"
- "співпадати" → "збігатися"
- "являється" → "є"
- "у даний момент" → "зараз"
"""
